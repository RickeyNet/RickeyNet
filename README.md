...
`Python` `Ansible` `Terraform` `AWS CloudFormation` `PowerShell` `REST APIs` `Jinja2` `Netmiko` `Nornir`
...
| Repo | What it does |
|------|-------------|
| [Fortinet-to-Cisco-firewall-config-tool](https://github.com/RickeyNet/Fortinet-to-Cisco-firewall-config-tool) | Three-phase FortiGate → Cisco FTD migration tool — converts FortiGate configs (YAML) to FTD-compatible JSON, imports via FDM REST API, and handles bulk cleanup/rollback. Full GUI and CLI. |
...
`CCNA` &nbsp;|&nbsp; `CompTIA Security+ CE` &nbsp;|&nbsp; `AWS Solutions Architect Associate`

---

## 📫 Connect

[![LinkedIn](https://img.shields.io/badge/LinkedIn-Rickey%20Cornett-0A66C2?style=flat&logo=linkedin)](https://www.linkedin.com/in/rickey-cornett-0054b51a8/)
